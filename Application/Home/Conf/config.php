...
return array(
    ...
    'TMPL_PARSE_STRING' => array(
        ...
        '__ADDONS__' => __ROOT__ . '/Template/' . MODULE_NAME . '/Public/Addons',
        '__IMG__'    => __ROOT__ . '/Template/' . MODULE_NAME . '/Public/images',
        '__CSS__'    => __ROOT__ . '/Template/' . MODULE_NAME . '/Public/css',
        '__JS__'     =>__ROOT__ . '/Template/' . MODULE_NAME . '/Public/js',
    ),
